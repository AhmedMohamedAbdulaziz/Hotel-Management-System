...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h2 class="fw-bold">Rooms</h2>
        <div>
            <a href="{{ route('dashboard') }}" class="btn btn-outline-secondary me-2"><i class="fa fa-arrow-left"></i> Dashboard</a>
            <a href="{{ route('rooms.create') }}" class="btn btn-gradient-primary"><i class="fa fa-plus"></i> New Room</a>
        </div>
    </div>
        ...
        <table class="table align-middle mb-0 table-hover table-striped">
            ...
            @forelse($rooms as $room)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('rooms.show', $room) }}" class="btn btn-info btn-sm me-1" title="Show"><i class="fa fa-eye"></i></a>
                        <a href="{{ route('rooms.edit', $room) }}" class="btn btn-warning btn-sm me-1" title="Edit"><i class="fa fa-edit"></i></a>
            ...
            @empty
                <tr><td colspan="7" class="text-center py-4 text-muted bg-light rounded-3">No rooms found. <br><small>Add your first room using the green button above!</small></td></tr>
            @endforelse
            </tbody>
        </table>
        </div>
